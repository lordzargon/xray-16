...
public:
    ...
    VkImage t_material_surf{ VK_NULL_HANDLE };
    ref_texture t_material;

    VkImage t_noise_surf[TEX_jitter_count]{};
    ref_texture t_noise[TEX_jitter_count];
    VkImage t_noise_surf_mipped{ VK_NULL_HANDLE };
...
public:
    ...
    void u_setrt(CBackend& cmd_list, const ref_rt& _1, const ref_rt& _2, const ref_rt& _3, const ref_rt& zb);
    void u_setrt(CBackend& cmd_list, u32 W, u32 H, VkImageView _1, VkImageView _2, VkImageView _3, VkImageView zb);

    VkImageView get_base_rt();
    VkImageView get_base_zb();

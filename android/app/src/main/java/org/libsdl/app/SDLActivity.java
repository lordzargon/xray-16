...
*/
    ...
    public static void setWindowStyle(boolean fullscreen) {
        // In OpenXRay on mobile, always force fullscreen immersive mode
    ...
    public void setOrientationBis(int w, int h, boolean resizable, String hint)
    {
        ...
        mSingleton.runOnUiThread(mSingleton.rehideSystemUi);
    }
    ...
    public void onSystemUiVisibilityChange(int visibility) {
        if ((visibility & View.SYSTEM_UI_FLAG_FULLSCREEN) == 0 || (visibility & View.SYSTEM_UI_FLAG_HIDE_NAVIGATION) == 0) {
            ...
            if (handler != null) {
                ...
                handler.postDelayed(rehideSystemUi, 1000);
            } else {
                runOnUiThread(rehideSystemUi);
            }
        }
